...
```
   dart lib/src/7-conditions/example_35.dart 
```
...
```
   dart lib/src/7-conditions/example_36.dart 
```
...
```
   dart lib/src/7-conditions/example_37.dart 
```
...
```
   dart lib/src/7-conditions/example_38.dart
```
...
Therefore, exceptions must be handled to prevent the application from unexpected termination. Here are some reasons why exception handling is necessary:
...
```
   dart lib/src/7-conditions/example_39.dart
```
...
```
    dart lib/src/7-conditions/example_40.dart
```